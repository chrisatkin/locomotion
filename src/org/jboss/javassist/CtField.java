...
import org.jboss.javassist.bytecode.*;
import org.jboss.javassist.compiler.CompileError;
import org.jboss.javassist.compiler.Javac;
import org.jboss.javassist.compiler.SymbolTable;
import org.jboss.javassist.compiler.ast.ASTree;
import org.jboss.javassist.compiler.ast.DoubleConst;
import org.jboss.javassist.compiler.ast.IntConst;
import org.jboss.javassist.compiler.ast.StringL;
...
public class CtField extends CtMember {
     ...
     * It represents a type including type variables.
     * See {@link org.jboss.javassist.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see org.jboss.javassist.bytecode.SignatureAttribute.ObjectType#encode()
     * @since 3.17
     */
     ...
     * See {@link org.jboss.javassist.bytecode.AttributeInfo}.
     *
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see org.jboss.javassist.CtField.Initializer#byNewArray(CtClass,int)
         * @see org.jboss.javassist.CtField.Initializer#byNewArray(CtClass,int[])
         */
