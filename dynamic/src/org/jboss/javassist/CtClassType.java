...
import org.jboss.javassist.bytecode.AccessFlag;
import org.jboss.javassist.bytecode.AnnotationsAttribute;
import org.jboss.javassist.bytecode.AttributeInfo;
import org.jboss.javassist.bytecode.BadBytecode;
import org.jboss.javassist.bytecode.Bytecode;
import org.jboss.javassist.bytecode.ClassFile;
...
import org.jboss.javassist.bytecode.ConstantAttribute;
import org.jboss.javassist.bytecode.Descriptor;
import org.jboss.javassist.bytecode.EnclosingMethodAttribute;
import org.jboss.javassist.bytecode.FieldInfo;
import org.jboss.javassist.bytecode.InnerClassesAttribute;
import org.jboss.javassist.bytecode.MethodInfo;
import org.jboss.javassist.bytecode.ParameterAnnotationsAttribute;
import org.jboss.javassist.bytecode.SignatureAttribute;
import org.jboss.javassist.bytecode.annotation.Annotation;
import org.jboss.javassist.compiler.AccessorMaker;
import org.jboss.javassist.compiler.CompileError;
import org.jboss.javassist.compiler.Javac;
import org.jboss.javassist.expr.ExprEditor;
...
class CtClassType extends CtClass {
   ...
   /**
    ...
    /**
     * @see org.jboss.javassist.CtClass#prune()
     * @see org.jboss.javassist.CtClass#stopPruning(boolean)
     */
    public void prune() {
        if (wasPruned)
            return;
