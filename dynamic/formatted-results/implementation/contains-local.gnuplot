...
plot "../dynamic/formatted-results/implementation/member_local" using ($1/1000):2 with linespoints title "hash set, size = n" lw 4,\
	"../dynamic/formatted-results/implementation/member_local" using ($1/1000):3 with linespoints title "hash set, default" lw 4,\
	"../dynamic/formatted-results/implementation/member_local" using ($1/1000):4 with linespoints title "guava" lw 4,\
